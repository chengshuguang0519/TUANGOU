	...
	<view class="pay-method-wrap">
		...
		<u-popup v-model="show" mode="center">
			<view class="payPupop">
				...
				<view class="inp">
					<u-input type="password" v-model="payPassword" @input="onchange" placeholder="请输入交易密码" clearable="false" border="true"/>
				</view>
			</view>
		</u-popup>
	</view>
...
export default {
	...
	onLoad() {
		console.log(this.$Route.query.goodsid,'Q')
		if(this.$Route.query.goodsid == uni.getStorageSync('goodsId')){
	...
	methods: {
		onchange(e){
			...
			if(this.payPassword.length == 6){
				pay = new Pay(that.payType, that.orderDetail, this.payPassword);
				this.show = false;
				this.payPassword = '';
			}
		},
