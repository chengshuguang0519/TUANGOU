...
<template>
	<view class="page_box">
		...
		<view class="content_box">
			<!-- 列表 -->
			<u-checkbox-group @change="checkboxGroupChange" activeColor="#ff9c00" v-if="!isEmpty">
			...
			<view class="tuijian" style="width: 750rpx;height: 88rpx;line-height: 88rpx;text-align: center;margin: 0 auto;">
				<!-- 推荐商品 -->
				<view class="" style="font-size: 36rpx;font-weight: 700;margin: 8rpx 0;">
					为您推荐
				</view>
		...
		<view class="foot_box " v-show="!isEmpty">
			<view class="tools-box u-flex u-row-between">
				<u-checkbox @change="onAllSel" activeColor="#ff9c00" shape="circle" :value="allSel">全选（{{ totalCount.totalNum }}）</u-checkbox>
				<view class="u-flex">
