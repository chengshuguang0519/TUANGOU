			...
			<view class="head-wrap" :style="{ background: detail.image ? `url(${detail.image}) no-repeat center / 100% 100%` : detail.color }">
				...
				<view class="user-head u-flex u-row-between">
					<view class="u-flex">
						...
						<!-- 等级 -->
						<view v-if="userInfo.is_vip" class="" style="display: flex;align-items: center;">
							<view class="" style="width: 40rpx;height: 40rpx;"><image style="width: 40rpx;height: 40rpx;" :src="userInfo.viplogo" mode=""></image></view>
							<view class="" style="font-size: 24rpx;color: #fff;margin-left: 10rpx;">{{userInfo.vipname}}</view>
						</view>
