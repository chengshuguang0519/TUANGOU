	...
	<view class="page_box">
		...
		<view class="content_box">
			<scroll-view scroll-y="true" @scrolltolower="loadMore" class="scroll-box">
				<u-checkbox-group @change="checkboxGroupChange" activeColor="#ff9c00">
				...
				<shopro-empty
					...
					tipText="暂无收藏"
					btnText="去首页逛逛"
					@click="$Router.replace('/pages/index/index')"
				></shopro-empty>
				<!-- 更多 -->
		...
		<view class="foot_box ">
			<view class="tools-box u-flex u-row-between u-flex-1" v-show="isEdit && !isEmpty">
				<u-checkbox shape="circle" activeColor="#ff9c00" @change="onAllSel" v-model="isAllSel"><text>全选</text></u-checkbox>
