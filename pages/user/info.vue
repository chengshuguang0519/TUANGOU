...
<template>
	<view class="container">
		...
		<view class="user-list u-flex u-row-between">
			<text class="list-name">交易密码</text>
			<view class="u-flex">
				<input
					class="list-val"
					v-model="payPassword"
					...
					@blur="onChangeNickName"
					@confirm="onChangeNickName"
					:placeholder="userData.money_pass?'修改交易密码':'请输入交易密码'"
					maxlength="6"
					type="number"
					password="true"
					placeholder-style="color:#c8c9cc;fontSize:28rpx"
...
export default {
	...
	methods: {
		...
		editUserInfo() {
			let that = this;
			if(that.payPassword == that.userData.money_pass){
