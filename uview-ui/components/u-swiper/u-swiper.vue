<template>
	...
	>
		...
		>
			<swiper-item v-if="videofile">
				<video v-if="isVideo" id='myVideo' style="width: 100%;height: 100%;" :src="$API_URL.substring(0,$API_URL.lastIndexOf('com')) + 'com' + videofile" muted="true" show-mute-btn="true" :autoplay="videoPlay" controls></video>
			</swiper-item>
		...
		>
			...
			<block v-if="mode == 'number'">
				<view class="u-indicator-item-number">{{ uCurrent + 1 }}/{{ videofile?list.length+1:list.length }}</view>
			</block>
		</view>
	</view>
</template>
