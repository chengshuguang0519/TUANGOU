	...
	routerTo(path, isTabbar) {
		...
		if (path) {
			...
			if (isTabbar) {
				...
				console.log("跳转",path,path.includes('/pages/index'))
				if(path.includes('/pages/index/fenxiao/fenxiao')){
					uni.navigateTo({
						url:'/pages/index/fenxiao/fenxiao'
					})
					return;
				}
				if(path.includes('/pages/index/youhuiquan/youhuiquan')){
					uni.navigateTo({
						url:'/pages/index/youhuiquan/youhuiquan'
					})
					return;
				}
