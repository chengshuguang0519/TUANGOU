...
export default {
	...
	user: {
		...
		set_selfetch: {
			url: 'store/set_selfetch',
			auth: false,
			method: 'POST',
			//拉新接口  post   pid
			//适用场景：A扫了B的个人名片，且A的注册时间（user/index返回的createtime）为当天，则请求index/newUser给B返奖励
		},
		...
		video_list: {
			url: 'index/video_list',
			auth: false,
			method: 'GET',
			// desc: '获取会员卡信息',
		},
		video_detail: {
			url: 'index/video_detail',
			auth: false,
			method: 'GET',
			// desc: '获取会员卡信息',
		},
		...
		wxMiniProgramRefresh: {
			url: 'user/wxMiniProgramRefresh',
			auth: false,
			method: 'POST',
			// desc: '微信小程序获取手机号',
		},
