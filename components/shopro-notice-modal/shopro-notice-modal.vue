		...
		<view v-for="(p, index) in newPopupList" :key="index">
			...
			>
				<view class="cu-dialog">
					...
					<view class="guanbi" @click="gg" style="text-align: center;"><image style="width: 60rpx; height: 60rpx;" src="../../static/images/guanbi.png" mode=""></image></view>
				</view>
			</u-popup>
		</view>
	</view>
...
export default {
	...
	methods: {
		gg(){
			...
			// 	_this.$http('user.buindUser',{uid:res.data.id,pid:2}).then(res=>{
