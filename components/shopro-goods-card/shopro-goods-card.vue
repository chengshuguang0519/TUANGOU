<template>
	...
	<view class="goods-box" @tap="click">
		...
		<view class="goods-bottom u-p-14" style="line-height: 40rpx;text-align: left;" >
			<!-- :style="type ? 'background-image: url(' + $IMG_URL + typeMap[type].goodsBg + ')' : ''"  秒杀背景色 -->
